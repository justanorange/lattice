    ...
    },
    {
      ...
      prizeTable: {
        rows: [
          ...
          { matches: [4, 1], prizePercent: 1.9 },
          { matches: [1, 4], prizePercent: 1.9 },
          { matches: [4, 0], prizePercent: 1.8 },
          { matches: [0, 4], prizePercent: 1.8 },
          { matches: [3, 3], prizePercent: 0.8 },
          { matches: [3, 2], prizePercent: 6.38 },
          { matches: [2, 3], prizePercent: 6.38 },
          { matches: [3, 1], prizePercent: 8.5 },
          { matches: [1, 3], prizePercent: 8.5 },
          { matches: [3, 0], prizePercent: 10.5 },
