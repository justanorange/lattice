...
function App() {
  ...
  const lotteries = [
    { id: '8_20_1', name: STRINGS.lottery_8_20_1, available: true },
    { id: '4_20_2', name: STRINGS.lottery_4_20_2, available: true },
    { id: '12_24', name: STRINGS.lottery_12_24, available: true },
    { id: '5_36_1', name: STRINGS.lottery_5_36_1, available: true },
    { id: '6_45', name: STRINGS.lottery_6_45, available: false },
    { id: '6_49', name: STRINGS.lottery_6_49, available: false },
  ];
                  ...
                  >
                    ...
                    <CardBody>
                      <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                        {STRINGS[`lottery_${lottery.id}_desc` as keyof typeof STRINGS] || 'Russian lottery'}
                      </p>
                      <Button
